        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                      <li class="breadcrumb-item"><a href="{{ route('maintenance.index') }}">Voids</a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <form action="{{ route('void.import.store') }}" class="dropzone" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="fallback">
