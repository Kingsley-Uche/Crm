...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="card-title">Create New Permit</h4>
                <p class="card-title-desc">Please fill in the required details to create a permit.</p>

               <form method="POST" action="{{ route('park.permits.store') }}">
    @csrf
    ...
    <div class="row">
        ...
        <!-- Existing fields start here -->
        <!-- Permit Name -->
        <div class="col-md-6 mb-3">
            <label for="permit_name">Permit Name</label>
            <input type="text" name="permit_name" class="form-control" required placeholder="Enter permit name" value="{{ old('permit_name') }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select name="park_id" class="form-control" required>
                ...
                @foreach ($parks as $park)
                    <option value="{{ $park->id }}" {{ old('park_id') == $park->id ? 'selected' : '' }}>{{ $park->name }}</option>
                @endforeach
            </select>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="fee" id="fee" class="form-control" required value="{{ old('fee') }}">
