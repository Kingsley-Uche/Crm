...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Edit Estate Owner</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Estate Owner Details</h4>
                <p class="card-title-desc">Update the estate owner information below.</p>
                ...
                <form method="POST" action="{{ route('estate_owners.update', $owner->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select @error('means_of_identification') is-invalid @enderror" 
                                ...
                                <option value="driver_licence" {{ old('means_of_identification', $owner->means_of_identification) == 'driver_licence' ? 'selected' : '' }}>Driver's License</option>
                                <option value="nis" {{ old('means_of_identification', $owner->means_of_identification) == 'nis' ? 'selected' : '' }}>NIS</option>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <small class="form-text text-muted">
                                Current: {{ basename($owner->identification_image) }} | 
                                Max size: 2MB. Accepted: JPEG, PNG, JPG, PDF | 
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control @error('next_of_kin') is-invalid @enderror" 
                                   ...
                                   value="{{ old('next_of_kin', $owner->next_of_kin) }}" 
                                   maxlength="160" 
                                   required>
                            @error('next_of_kin')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control @error('next_of_kin_phone') is-invalid @enderror" 
                                   ...
                                   value="{{ old('next_of_kin_phone', $owner->next_of_kin_phone) }}" 
                                   required>
