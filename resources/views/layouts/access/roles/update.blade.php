    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body px-4">
                ...
                <p class="card-title-desc mb-4">Update the role details and assigned permissions.</p>
                ...
                <form method="POST" action="{{ route('access.roles.update', $role->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            @php $assignedPermissions = old('permissions', $role->permissions->pluck('id')->toArray()); @endphp
                            ...
                            @foreach ($permissions as $permission)
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch d-flex align-items-center">
                                        ...
                                        />
                                        <label 
                                            class="form-check-label ms-2 permission-label {{ in_array($permission->id, $assignedPermissions) ? 'text-success' : '' }}"
                    ...
                    <div style="max-width: 500px;">
                        <button type="submit" class="btn btn-success waves-effect waves-light me-2">Update Role</button>
...
<script>
    ...
    function updateCheckboxStyle(checkbox) {
        if (checkbox.checked) {
            ...
            checkbox.nextElementSibling.classList.add('text-success');
        } else {
            checkbox.classList.remove('bg-success');
            checkbox.nextElementSibling.classList.remove('text-success');
        }
    }
