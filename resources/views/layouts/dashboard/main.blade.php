...
<div class="page-content">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-truncate font-size-14 mb-2">Blocks</p>
                                <h4 class="mb-2">{{count($blocks)}}</h4>
    ...
    <div class="card-body">
        <div class="d-flex">
            <div class="flex-grow-1">
                <p class="text-truncate font-size-14 mb-2">Voids</p>

                @php
                    $totalVoids = $voids->sum();
                @endphp

                <h4 class="mb-2">{{ $totalVoids }}</h4>

                @foreach($voids as $type => $count)
                    <p class="mb-1">{{ $type }}: <strong>{{ $count }}</strong></p>
                @endforeach
