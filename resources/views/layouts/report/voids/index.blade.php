...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Voids Report</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('locations.index') }}">Voids</a></li> 
...
<div class="row">
    <div class="col-12">
        <form action="{{ route('voids.report.generate') }}" method="POST">
            @csrf

            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Generate Voids Report</h4>
                    <p class="card-title-desc">Enter the dates to generate voids report.</p>
