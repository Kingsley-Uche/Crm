...
@endphp
    ...
    <!-- Footer -->
    <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between mt-4 py-4 px-4 px-xl-5" style="background-color: {{ $brandColor }}; color: white;" position-fixed w-100 bottom-0">
        <div>
