...
public function UserIndex()
{
    ...
    $repairs = Repairs::select('id', 'progress')->get();
    // Count repairs grouped by 'progress'
    $repairProgressCounts = $repairs->groupBy('progress')->map->count();
    ...
    return view('user.dashboard.home.index', compact(
        'user',
        'blocks',
        'totalBlocks',
        'shelterTypeCounts',
